...
REMINDER_HOURS = os.getenv("REMINDER_HOURS", "5,7,10,13,16")  # comma-separated hours
...
def process_update(u):
    ...
    if text.startswith("/start"):
        welcome = (
            "Привет! Я — бот, который будет напоминать пить воду и заботиться о тебе.\n\n"
            ...
            "Это поможет поднять твою продуктивность и наладить здоровье.\n\n"
            "Кстати сегодня ты уже молодец, награди себя вкусняшками.\n\n"
        )
